...
%\newcommand{\Cprod}{\mathpalette\superimpose{{\box}{\times}}
\newcommand{\Cprod}{\mathclap{\box}\times}
%\newcommand{\Boxtimes}{\scalebox{3}{\boxtimes}}
\newcommand{\Boxtimes}{\mathlarger{\mathlarger{\boxtimes}}}
